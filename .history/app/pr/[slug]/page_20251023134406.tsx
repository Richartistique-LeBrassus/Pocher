...
//
  ...
  const fourthImage = "/images/1.webp";
  const fifthImage = "/images/1.webp";
  const sixthImage = "/images/1.webp";
      ...
      <>
        ...
        <div className="w-full min-h-screen">
          <div className="flex flex-col w-full min-h-fit gap-1">
            ...
            >
                <ProductImageWithLightbox  images="/images/1.webp" productName="Porsche 917k Gulf Edition" />
