          ...
          <div className="flex flex-col w-full min-h-fit gap-1">
            ...
            w-full max-w-3xl mx-auto mt-7 ">
              <div className="relative w-full h-[400px] lg:h-fit px-5 py-6 sm:px-12">
                ...
                >
                  <p className="italic text-[25px] sm:text-3xl text-white">
                    "Michael Delaney's Porsche"
                  </p>
                  <h1 className="font-extrabold leading-12
                   text-amber-400 text-3xl md:text-4xl lg:text-[40px] max-w-lg mx-auto py-4"
                  >
            ...
            relative w-full h-[80vw] sm:h-[47vw] md:h-[43vw] lg:h-[40vw] xl:h-[34vw] mx-auto">
                <Image
                  ...
                  priority
                />
                <div className="absolute inset-x-0 top-0 h-32 md:h-42 lg:h-60 bg-linear-to-b from-neutral-950 
