            ...
            <AnimatePresence>
              {open && (
                <motion.button
                  ...
                  className="absolute top-4 right-4 z-50 bg-white/30 p-2 text-neutral-400 hover:bg-amber-400 hover:text-black rounded-xs hover:cursor-pointer transition"
...
>
  ...
  />
                ...
                <button
                  ...
                  className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/30 p-3 text-amber-400 hover:bg-amber-400 hover:text-black rounded-xs hover:cursor-pointer transition"
                >
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/30 p-3 text-amber-400 hover:bg-amber-400 hover:text-black rounded-xs hover:cursor-pointer transition"
                >
