            ...
            <AnimatePresence>
              {open && (
                <motion.button
                  ...
                  className="absolute top-4 right-4 z-50 bg-white/30 p-2 text-black hover:bg-white/10 rounded-xs hover:cursor-pointer transition"
...
>
  ...
  />
                ...
                <button
                  ...
                  className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/30 p-3 text-black hover:bg-amber-400/10 rounded-xs hover:cursor-pointer transition"
                >
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/30 p-3 text-black hover:bg-amber-400/10 rounded-xs hover:cursor-pointer transition"
                >
