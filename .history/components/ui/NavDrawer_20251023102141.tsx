          ...
          <div className="text-sm uppercase tracking-wide text-center 
            ...
            <a href="https://int.balmain.com/">
              <div className="tracking-widest uppercase">
                <p className="text-xs mb-2">Pristine de Luxe Model Kits by</p>
                <div className="flex flex-col items-center min-h-[100px] p-auto">
                  <div className="tracking-widest uppercase inline-flex items-center logo -mt-6">
                    <h2 className="text-5xl font-extrabold text-amber-400 tracking-tight">R</h2>
                    <div className="flex flex-col items-center align-middle justify-center h-full mt-2">                      
                      <h2 className="text-xs font-bold text-amber-400 tracking-tight">
                        Pocher
                      </h2>
                    </div> 
                  </div>                     
