...
>
  ...
  />
                ...
                <button
                  ...
                  className="absolute left-4 top-1/2 -translate-y-1/2 p-3 text-amber-400 rounded-4xl hover:cursor-pointer transition"
                >
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 p-3 text-amber-400 rounded-4xl hover:cursor-pointer transition"
                >
    ...
    {images.map((img, i) => (
      ...
      >
        ...
        {i === index && (
          <motion.div
            layoutId="thumb-border"
            className="absolute inset-0 rounded-4xl border-3 border-red-800"
            transition={{ type: "spring", stiffness: 500, damping: 40 }}
          />
        )}
      </motion.button>
