        ...
        tracking-tight mb-14 md:mb-16 lg:mb-24 2xl:mb-28">
          <button
            ...
            className={`transition font-semibold uppercase hover:cursor-pointer ${
              activeTab === "boutique" ? "text-neutral-100 underline underline-amber-400 underline-offset-4" : "text-neutral-100"
            }`}
          >
            Look Book
          </button>
          <button
            ...
            className={`transition font-semibold uppercase hover:cursor-pointer ${
              activeTab === "lookbook" ? "text-neutral-100 underline underline-amber-400 underline-offset-4" : "text-neutral-100"
            }`}
          >
            Boutique
          </button>
