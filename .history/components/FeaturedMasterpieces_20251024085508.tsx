...
const cardVariants: Variants = {
  ...
  return (
   <section
     className="w-full py-44 sm:py-[184px] md:py-48 lg:py-56 px-4 md:px-16
     2xl:py-60">
      <div
        ref={wrapperRef}
        ...
        <h2
          ...
          font-extrabold mb-7 tracking-widest text-neutral-100 uppercase"
        >
          Mechanical <span className="text-amber-400">Icons</span>
        </h2>
        ...
        tracking-tight mb-14 md:mb-16 lg:mb-24 2xl:mb-28">
          <button
            ...
            className={`transition font-semibold uppercase hover:cursor-pointer ${
              activeTab === "boutique" ? "text-neutral-100 underline decoration-amber-400 decoration-2 underline-offset-8" : "text-neutral-200"
            }`}
          >
            Look Book
          </button>
          <button
            ...
            className={`transition font-semibold uppercase hover:cursor-pointer ${
              activeTab === "lookbook" ? "text-neutral-100 underline decoration-amber-400 decoration-2 underline-offset-8" : "text-neutral-200"
            }`}
          >
            Boutique
          </button>
                ...
                >
                  ...
                  <span
                    ...
                    className="absolute right-2 z-20 bg-white/10 font-bold 
                     text-amber-400 rounded-xs px-2 py-4 hover:cursor-pointer"
                  >
